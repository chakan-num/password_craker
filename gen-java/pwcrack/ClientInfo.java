...
public class ClientInfo implements org.apache.thrift.TBase<ClientInfo, ClientInfo._Fields>, java.io.Serializable, Cloneable, Comparable<ClientInfo> {
  ...
  public ClientInfo setClient_id(int client_id) {
    this.client_id = client_id;
    setClient_idIsSet(true);
    return this;
  }
  ...
  public void unsetClient_id() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __CLIENT_ID_ISSET_ID);
  }

  /** Returns true if field client_id is set (has been assigned a value) and false otherwise */
  public boolean isSetClient_id() {
    return EncodingUtils.testBit(__isset_bitfield, __CLIENT_ID_ISSET_ID);
  }

  public void setClient_idIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __CLIENT_ID_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    boolean present_client_id = true;
